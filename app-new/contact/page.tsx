...
export const metadata: Metadata = {
  title: "Contact Us - Microtex International",
  description:
    "Get in touch with our team for packaging machinery, spare parts, and support services.",
};
              ...
              <div className="padding-section-xlarge">
                <div className="w-layout-grid header-main_component">
                  <div className="header-main_content-left">
                    <h1 className="heading-style-h4 _w-100">Talk to an expert</h1>
                  </div>
                  <div className="header-main_content-right">
                    <p className="heading-style-h3 text-color-white">
                      At Microtex International, we understand the importance of reliable packaging solutions, and our team of experts is ready to assist you.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="padding-section-large">
                <div className="w-layout-grid lets-talk_component">
                  ...
                  <div className="lets-talk_content-right">
                    <p className="heading-style-h3 text-color-white">
                      Whether you have specific questions about our products, want to discuss a potential collaboration, or simply need more information, our team at Microtex International is here to help.
                    </p>
                  </div>
                </div>
              </div>
